    ...
    return (
        <div className='py-2 sm:py-3 '>
            <div className='pl-6 pr-3 flex items-center justify-between' >
                <p className='text-[#9BA2B2] font-semibold text-[10px] sm:text-sm'>Total users: 100</p>

                <div>
                    <select
                        className='px-3 py-[1px] rounded-sm text-[10px] sm:text-sm bg-[#6F5CC3] text-white outline-none cursor-pointer'
